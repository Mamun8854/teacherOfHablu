...
const Header = () => {
  ...
  return (
    <div className="px-4 fixed z-50 w-full top-0 py-5 bg-white mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
      <div>
        <div className="relative flex items-center justify-between z-50">
          <div className="flex items-center">
            <Link
              to="/"
              aria-label="Teacher Of Hablu"
              title="Teacher Of Hablu"
              className="inline-flex items-center mr-8"
            >
              <img className="w-16" src={Image} alt="" />
              <span className="ml-2 text-xl font-extrabold tracking-wide text-gray-900 uppercase">
